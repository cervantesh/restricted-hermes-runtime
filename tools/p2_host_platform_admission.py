#!/usr/bin/env python3
"""Fail closed unless execution is on #31's representative host class.

This intentionally makes no host-control claim and writes no receipt.  It is
the first guard a future P2 collector must pass before it can inspect Docker,
secrets, network policy, or state.  Its diagnostics are deliberately bounded
so an unsupported machine cannot leak its hostname, release, or paths.
"""
